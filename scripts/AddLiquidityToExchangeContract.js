...
const lakshmiKanthTokenQuantityForLiquidity = web3.utils.toHex(15*10**18) // 15  tokens
const DEADLINE = 1742680400 // deadline = w3.eth.getBlock(w3.eth.blockNumber).timestamp

const tx = contract.methods.addLiquidity(1, lakshmiKanthTokenQuantityForLiquidity, DEADLINE);
