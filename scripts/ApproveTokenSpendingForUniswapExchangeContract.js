...
const ApproveTokenSpendingForUniswapExchangeContract = {
  approveTokenSpending: async () => {
    ...
    const lakshmiKanthTokenQuantityForApproval = web3.utils.toHex(
      100 * 10 ** 18
    );
    ...
    const nonceNumber = await web3.eth.getTransactionCount(transactionMaker);
    ...
    // get the number of transactions sent so far so we can create a fresh nonce
      ...
      return ApproveTokenSpendingForUniswapExchangeContract.sendSigned(txData, function(err, result) {
